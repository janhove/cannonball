...
data are analysed using a randomisation test.
...
`vignette("cluster-randomisation", package = "cannonball")` for details.
...
Refer to the vignette (article)
`vignette("check-assumptions", package = "cannonball")` for details.
...
Refer to the vignette (article)
`vignette("randomisation-tests", package = "cannonball")` for details.
